...
const std::vector<Vertex> indexVertices = {
    ...
    {{-0.5f, 0.5f, -0.5f}, {1.0f, 0.0f, 1.0f}, {1.f, 1.f}}};
...
void HelloTriangleApplication::createTextureImage() {
  ...
  std::cout << "image info: widt=" << texWidth << "\theight=" << texHeight
            << std::endl;
...
void HelloTriangleApplication::createVertexBuffer() {
  VkDeviceSize bufferSize = sizeof(indexVertices[0]) * indexVertices.size();
  ...
  memcpy(data, indexVertices.data(), (size_t)bufferSize);
  vkUnmapMemory(device, stagingBufferMemory);
...
void HelloTriangleApplication::drawFrame() {
  ...
  */
  ...
  if (result == VK_ERROR_OUT_OF_DATE_KHR) {
    recreateSwapChain();
    std::cout << "window's size has changed" << std::endl;
    return;
...
void HelloTriangleApplication::updateUniformBuffer(int currentImage) {
  ...
  ubo.model = glm::rotate(glm::mat4(0.2f), time * glm::radians(90.0f),
...
VkExtent2D HelloTriangleApplication::chooseSwapExtent(
  ...
  std::cout << "capabilities width =" << capabilities.currentExtent.width
            << ", height=" << capabilities.currentExtent.height << std::endl;
...
void HelloTriangleApplication::createImage(
    int width, int height, VkFormat format, VkImageTiling tiling,
